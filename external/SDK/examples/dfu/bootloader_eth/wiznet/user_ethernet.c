...
#define SPIM0_SCK_PIN   NRF_GPIO_PIN_MAP(1, 15)  // SPI clock GPIO pin number.
#define SPIM0_MOSI_PIN  NRF_GPIO_PIN_MAP(1, 13)  // SPI Master Out Slave In GPIO pin number.
#define SPIM0_MISO_PIN  NRF_GPIO_PIN_MAP(1, 14)  // SPI Master In Slave Out GPIO pin number.
#define SPIM0_SS_PIN    NRF_GPIO_PIN_MAP(1, 12)  // SPI Slave Select GPIO pin number.
